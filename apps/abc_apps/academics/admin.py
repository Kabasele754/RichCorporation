...
from apps.abc_apps.academics.models import ClassRoom, Course, MonthlyClassGroup, Room, SchoolCampus, StudentMonthlyEnrollment, TeacherCourseAssignment, MonthlyGoal
