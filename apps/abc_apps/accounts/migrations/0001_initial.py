    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('student', 'Student'), ('teacher', 'Teacher'), ('secretary', 'Secretary'), ('principal', 'Principal')], default='student', max_length=12)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('speciality', models.CharField(choices=[('grammar', 'Grammar'), ('vocabulary', 'Vocabulary'), ('support', 'Support')], default='support', max_length=12)),
